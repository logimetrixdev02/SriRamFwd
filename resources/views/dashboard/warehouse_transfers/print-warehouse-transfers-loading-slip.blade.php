						...
						<div class="col-sm-4 col-sm-offset-4" id="print_area">
							<div class="widget-box transparent" style="border: 1px solid #ccc;">
								...
								<div class="widget-toolbar no-border invoice-info" style="float:left;">
									...
									<span class="red" style="margin-top: 5px; font-size: 18px;">{{$warehouse_transfer_loading->id}}</span>

									<div class="space"></div><div class="space"></div>
									<span class="invoice-info-label">{{__('messages.Date')}} :</span>
									<span class="blue">{{ date('d/m/Y',strtotime($warehouse_transfer_loading->created_at)) }}</span>
								</div>
								<div class="widget-header widget-header-large">
									@php
									$encodedLabourSlipQr = base64_encode('warehouse_transfer_loading_labour_slip,'.$warehouse_transfer_loading->id);
									@endphp
								...
								<div class="widget-body">
													...
													<ul class="list-unstyled spaced">
														<li>
															...
															<li>
																...
																<div class="col-sm-6"> <span style="float: left;">{{$warehouse_transfer_loading->labour_name}}</span></div><br clear="all">
															</li>


															<li>
																<div class="col-sm-5"><strong style="float: left;font-size: 16px;"> {{__('messages.TruckNumber')}}</strong></div>
																<div class="col-sm-6"> <span style="float: left;">{{$warehouse_transfer_loading->truck_number}}</span></div><br clear="all">
															</li>
															<li>
																<div class="col-sm-5"><strong style="float: left;font-size: 16px;"> {{__('messages.Quantity')}}</strong></div>
																<div class="col-sm-6"> <span style="float: left;">{{$warehouse_transfer_loading->quantity}} {{getModelById('Unit',$warehouse_transfer_loading->unit_id)->unit}}</span></div><br clear="all">
															</li>
															<li>
																<div class="col-sm-5"><strong style="float: left;font-size: 16px;">Slip Generated By</strong></div>
																<div class="col-sm-6"> <span style="float: left;">{{is_null(getModelById('User',$warehouse_transfer_loading->user_id)) ? "":getModelById('User',$warehouse_transfer_loading->user_id)->name}}</span></div><br clear="all">
															</li>
									...
									<div class="widget-header widget-header-large">
										@php
										$encodedLoadingSlipQr = base64_encode('warehouse_transfer_loading_slip,'.$warehouse_transfer_loading->id);
										@endphp
										<h3 class="widget-title grey lighter" style="float:right">
														...
														<ul class="list-unstyled spaced">
															...
															<li>
																...
																<div class="col-sm-6"> <span style="float: left;">
																	{{getModelById('Warehouse',$warehouse_transfer_loading->from_warehouse_id)->name}}
															...
															<li>
																...
																<div class="col-sm-6"> <span style="float: left;">
																	{{getModelById('Warehouse',$warehouse_transfer_loading->to_warehouse_id)->name}}
																</span></div><br clear="all">
															...
															<li>
																...
																<div class="col-sm-6"> <span style="float: left;">	{{getModelById('Product',$warehouse_transfer_loading->product_id)->name}}</span></div><br clear="all">
															</li>

															<li>
																<div class="col-sm-5"><strong style="float: left;font-size: 16px;">{{getModelById('Unit',$warehouse_transfer_loading->unit_id)->unit}}</strong></div>
																<div class="col-sm-6"> <span style="float: left;">{{$warehouse_transfer_loading->quantity}}</span></div><br clear="all">
															</li>
															...
															<li>
																...
																<div class="col-sm-6"> <span style="float: left;">{{is_null(getModelById('Transporter',$warehouse_transfer_loading->transporter_id)) ? "":getModelById('Transporter',$warehouse_transfer_loading->transporter_id)->name}}</span></div><br clear="all">
															</li>
