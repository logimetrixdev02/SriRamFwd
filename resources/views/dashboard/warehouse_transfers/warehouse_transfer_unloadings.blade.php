...
@section('title','Warehouse Transfer Unloading')
@section('style')
	...
	<div class="main-content-inner">
		<div class="breadcrumbs ace-save-state" id="breadcrumbs">
			<ul class="breadcrumb">
				...
				<li class="active"> Warehouse Transfer Unloading</li>
			</ul>
		</div>

		<div class="page-content">
			<h3 class="header smaller lighter blue"> Warehouse Transfer Unloading</h3>
						...
						<div class="dataTables_borderWrap">
							<table id="dynamic-table" class="table table-striped table-bordered table-hover">
								...
								<tbody>
									...
									@foreach($warehouse_transfer_unloadings as $warehouse_transfer_unloading)
									<tr>
										<td>{{$warehouse_transfer_unloading->id}}</td>
										<td>{{$warehouse_transfer_unloading->from_warehouse->name}}</td>
										<td>{{$warehouse_transfer_unloading->to_warehouse->name}}</td>
										<td>{{$warehouse_transfer_unloading->product_brand->name}}</td>
										<td>{{$warehouse_transfer_unloading->product->name}}</td>
										<td>{{$warehouse_transfer_unloading->quantity}} {{$warehouse_transfer_unloading->unit->unit_name}}</td>
										<td>{{$warehouse_transfer_unloading->labour_name}}</td>
										<td>{{$warehouse_transfer_unloading->labour_rate}}</td>
										<td>
										...
										<td>{{$warehouse_transfer_unloading->labour_paid_amount}}</td>
										<td><a href="{{URL('/user/print-warehouse-transfer-unloading-slip/'.$warehouse_transfer_unloading->id)}}"><i class="fa fa-print fa-2x"></i></a></td>
