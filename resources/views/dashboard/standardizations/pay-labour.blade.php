	...
	<div class="main-content-inner">
		<div class="breadcrumbs ace-save-state" id="breadcrumbs">
			<ul class="breadcrumb">
				...
				<li><a href="{{'/user/standardizations'}}"> Stantdardization</a></li>
		...
		<div class="page-content">
			...
			<form action="{{url('/user/pay-standardization')}}" method="post" role="form" id="labourPaymentForm">
				{{ csrf_field() }}
				<div class="container">
					<div class="row">
							...
							<div class="panel-body">
								<div class="col-md-4">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="qr_data" id="qr_data" onchange="getStandardizationSlipDetails(this.value)">
									</div>
								</div>
								...
								<div id="details" style="display: none;">
									...
									<div class="col-md-3">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="open_quantity" id="open_quantity" readonly="">
										</div>
									</div>

									<div class="col-md-3">
										<div class="form-group">
											<label for="packed_quantity">Packed Quantity</label>
											<input type="text" class="form-control" name="packed_quantity" id="packed_quantity" readonly="">
										</div>
									</div>
...
<script type="text/javascript">
	...
	function getStandardizationSlipDetails(qr_value){
		var url ="{{url('get-standardization-slip-details')}}";
		if (qr_value == "") {
			swal({
				...
				success:function(data){
					...
					if (data.flag) {
						...
						if(data.labour_payment.is_paid == "1"){
							...
							$("#open_quantity").val(data.labour_payment.open_quantity);
							$("#packed_quantity").val(data.labour_payment.packed_quantity);
							$("#labour_rate").val(data.labour_payment.labour_rate);
							$("#amount_to_pay").val(parseFloat(data.labour_payment.labour_rate * data.labour_payment.packed_quantity));
							$("#details").show();
						}
					} else {
