	...
	<div class="main-content-inner">
		<div class="breadcrumbs ace-save-state" id="breadcrumbs">
			<ul class="breadcrumb">
				...
				<li class="active"> Standard Labour Payments</li>
			</ul>
		</div>

		<div class="page-content">
			<h3 class="header smaller lighter blue"> Standard Labour Payments</h3>
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<div class="table-header">
						Results for "Latest Generated Standard Labour Payments"
							...
							<table id="dynamic-table" class="table table-striped table-bordered table-hover">
								...
								<tbody>
									...
									<tr>
										...
										<td>{{$standardization->labour_name}}</td>
										<td>{{$standardization->labour_rate}}</td>
										<td>{{$standardization->packed_quantity * $standardization->labour_rate}}</td>
										<td>
											@if($standardization->is_paid == 0)
										...
										<td>
											...
											{{ getModelById('User',$standardization->paid_by)->name}}
											@else
											--
											@endif
										</td>
										<td>
											@if($standardization->is_paid == 1)
											{{$standardization->payment_amount}}
											@else
											--
											@endif
										</td>
										...
										<td>
											@if($standardization->is_paid == 1)
											{{date('d/m/Y',strtotime($standardization->payment_date))}}
											@else
											--
											@endif
										</td>

										<td><a href="{{URL('/user/print-standardization-slip/'.$standardization->id)}}"><i class="fa fa-print fa-2x"></i></a></td>
