...
<div class="main-content">
	<div class="main-content-inner">
		...
		<div class="page-content">
			...
			<form action="{{url('/user/pay-direct-labour-payment')}}" method="post" role="form" id="labourPaymentForm">
				{{ csrf_field() }}
				<div class="container">
					<div class="row">
							...
							<div class="panel-body">
								...
								<div id="details" style="display: none;">
									...
									<div class="pull-right">
										<a href="{{URL('/user/pay-direct-labour-payment')}}" class="btn btn-default" >Reset</a>
...
<script type="text/javascript">
	...
	function getLoadingSlipDetails(qr_value){
		var url ="{{url('get-direct-labour-slip-details')}}";
		if (qr_value == "") {
			swal({
				...
				success:function(data){
					...
					if (data.flag) {
						...
						if(data.labour_payment.is_paid == "1"){
							...
							$("#amount").val(data.labour_payment.amount);
							$("#description").val(data.labour_payment.description);
							$("#amount_to_pay").val(data.labour_payment.amount);
							$("#details").show();
						}
					} else {
