	...
	<div class="main-content-inner">
		<div class="breadcrumbs ace-save-state" id="breadcrumbs">
			<ul class="breadcrumb">
				...
				<li class="active">Retailer Sale Report</li>
			</ul>
		</div>
		<div class="page-content">
			<h3 class="header smaller lighter blue">Retailer Sale Report</h3>
			...
			<div class="row">
				<div class="col-xs-12">
						...
						<div class="row">
							...
							<div class="col-md-3">
								<div class="form-group">
									<label for="master_rake_id">Retailer</label>
									<select class="form-control select2" name="retailer_id" id="retailer_id">
										<option value="">Select Retailer</option>
										@foreach($retailers as $retailer)
										<option value="{{$retailer->unique_code}}" {{isset($retailer_id) && $retailer_id==$retailer->id ? "selected":""}}>{{$retailer->name}} [{{$retailer->unique_code}}]</option>
										@endforeach()
					...
					<div class="table-header">
						Retailer Wise Sale Total (<b><span style="color: orange;" id="grand_total"></span></b>)
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#filter').click(function(){
				...
				if(retailer_id !='' && from_date != '' &&  to_date != '')
				{
					
				$('#dynamic-table').DataTable().destroy();
				display(retailer_id,from_date, to_date);
				}else if(retailer_id!=''){
						$('#dynamic-table').DataTable().destroy();
					display(retailer_id,from_date="", to_date="");
				}else{
	...
	function display(retailer_id='',from_date = '', to_date = ''){
				 let total_bag =0;
					var myTable=$('#dynamic-table').DataTable({
							...
							"aaSorting": [],
							"ajax":{
								"url": "{{ route('retailer.sale-reports') }}",
