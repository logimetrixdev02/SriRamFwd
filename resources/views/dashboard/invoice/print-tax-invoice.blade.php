								...
								<table cellspacing="0" cellpadding="0" width="100%" style="margin:0px; padding: 0px;">
									<tr>
										<td style="height:40px;  ">Invoice No. <br/>
											<strong>{{getModelById('InvoiceType',$invoice_data['invoice_type_id'])->invoice_type}}</strong>
										</td>
				...
				<tr>
					<td width="100%">
						<table cellspacing="0" cellpadding="0" width="100%">
							...
							$total_amount = $product_rate[$i] * $quantity[$i];
							...
							$final_show_amount = $products_total_amount + $total_sgst + $total_cgst;
							@endphp
							<tr>
								...
								<td width="8%" style="border-top:1px solid; border-right:1px solid; text-align:center; height:30px;">{{$product_rate[$i]}}</td>
				...
				<tr>
					<td width="100%">
						<table cellspacing="0" cellpadding="0" width="100%">
							...
							@php
							$product_details = getModelById('Product',$product);
							$total_amount = $product_rate[$j] * $quantity[$j];
