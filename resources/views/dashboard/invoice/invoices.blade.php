			...
			<div class="row">
				<div class="col-xs-12">
					...
					<div class="table-header">
						Results for "Latest Punched Invoices"
						<div class="widget-toolbar no-border">
							<a class="btn btn-xs bigger btn-danger" href="{{URL('/user/punch-invoice')}}">
								Punch Invoice
						...
						<table id="dynamic-table" class="table table-striped table-bordered table-hover">
							...
							<tbody>
								...
								<tr id="tr_{{$invoice->id}}">
									...
									<td>{{date('d/m/Y', strtotime($invoice->received_date))}}</td>
									<td>{{$invoice->received_amount}}</td>
									<td>{{$invoice->inovice_remark}}</td>
									<td>
