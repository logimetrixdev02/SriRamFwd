								...
								<table cellspacing="0" cellpadding="0" width="100%" style="margin:0px; padding: 0px;">
									...
									<tr>
										<td style="height:40px;  ">Invoice No. <br/>
											<strong>{{$invoice_data['invoice_number']}}</strong>
										</td>
					...
					<td width="100%">
						<table cellspacing="0" cellpadding="0" width="100%">
							...
							<tr>
								...
								<td width="8%" style="border-top:1px solid; border-right:1px solid; text-align:center; height:30px;">{{$quantity[$i]}} {{$product_unit}}s</td>
							...
							<tr>
								...
								<td style="border-top:1px solid;border-top:1px solid; border-right:1px solid; text-align:center; height:30px;">{{$total_quantity}} {{$product_unit}}s</td>
								<td style="border-top:1px solid; border-right:1px solid; text-align:right; height:30px;"></td>
