...
<div class="main-content">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<div class="table-header">
						Results for "Latest Registered Roles"
						<div class="widget-toolbar no-border">
							<a class="btn btn-xs bigger btn-danger dropdown-toggle"  data-toggle="modal" href='#addRoleModal'>
								Add
								...
								<tr id="tr_{{$role->id}}">
									...
									<td>
										<div class="hidden-sm hidden-xs btn-group">
												...
												<a class="btn btn-xs btn-info" onclick="getEdit({{$role->id}})" >
	...
	{{--
												...
												--}}
												<a href="/user/assign-permissions/{{$role->id}}" class="btn btn-xs btn-info" >
		...
		<div class="modal-dialog modal-sm">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form action="" role="form" id="addRoleForm">
						<div class="row">
							<div class="col-md-12">
					...
					<div class="modal-footer">
						...
						<button type="button" id="addRoleBtn" class="btn btn-primary">Submit</button>
					</div>
				</form>
			</div>
		</div>
	...
	<script type="text/javascript">
		...
		<script>
			...
			function getEdit(id){
				if(id == ""){
					swal('Error','Role id is missing','warning');
				}else{
					$.ajax({
						url: "{{url('/user/edit-role/')}}"+"/"+id,
						type: 'GET',
						success:function(data){
							$('#EditBody').html(data);
			...
			function updateRole(){
				...
				$.ajax({
					...
					success: function(data){
						console.log(data);
						if(!data.flag){
							showError('edit_role_error',data.errors.role);
						}else{
							swal({
								title: "Success!",
								text: data.message,
