				...
				<div class="col-xs-12">
					...
					<div class="table-header">
						...
						<div class="widget-toolbar no-border">
							<a class="btn btn-xs bigger btn-danger dropdown-toggle"  data-toggle="modal" href='#addClientModal'>
								Add
								...
								<tr id="tr_{{$client->id}}">
									...
									<td>
										<div class="hidden-sm hidden-xs btn-group">
											<a class="btn btn-xs btn-info" onclick="getEdit({{$client->id}})" >
												<i class="ace-icon fa fa-pencil bigger-120"></i>
											</a>

											<button class="btn btn-xs btn-danger" onclick="deleteClient({{$client->id}})" >
	...
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form action="" role="form" id="addClientForm">
					<div class="row">
				...
				<div class="modal-footer">
					...
					<button type="button" id="addClientBtn" class="btn btn-primary">Submit</button>
				</div>
			</form>
		</div>
	</div>
...
<script type="text/javascript">
	...
	jQuery(function($) {
		...
		<script>
			...
			function getEdit(id){
				if(id == ""){
					swal('Error','Client id is missing','warning');
				}else{
					$.ajax({
						url: "{{url('/user/edit-client/')}}"+"/"+id,
						type: 'GET',
						success:function(data){
							$('#EditBody').html(data);
				...
				$.ajax({
					...
					success: function(data){
						...
						if(!data.flag){
							...
							showError('edit_company_error',data.errors.company_id);
						}else{
							swal({
								title: "Success!",
								text: data.message,
