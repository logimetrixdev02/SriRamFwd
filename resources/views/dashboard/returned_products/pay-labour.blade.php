	...
	<div class="main-content-inner">
		<div class="breadcrumbs ace-save-state" id="breadcrumbs">
			<ul class="breadcrumb">
				...
				<li><a href="{{'/user/returned-slip'}}"> Returned Product</a></li>
		...
		<div class="page-content">
			...
			<form action="{{url('/user/pay-returned-product-labour')}}" method="post" role="form" id="labourPaymentForm">
				{{ csrf_field() }}
				<div class="container">
					<div class="row">
							...
							<div class="panel-body">
								...
								<div id="details" style="display: none;">
									...
									<div class="pull-right">
										<a href="{{URL('/user/pay-returned-product-labour')}}" class="btn btn-default" >Reset</a>
								...
								<div class="labour-payment-error" style="display: none;">
									<div class="col-md-offset-4">
										<span id="returned_product_error_span" style="font-size: 30px; color: red; text-align: center;"></span>
									</div>
								</div>
							</div>
						</div>
			...
			$.ajax({
				...
				success:function(data){
					...
					if (data.flag) {
						...
						if(data.return_product.is_labour_paid == "1"){
							$("#details").html(`<div class="labour-payment-error" style="">
								<div class="col-md-offset-4">
								<span id="returned_product_error_span" style="font-size: 30px; color: red; text-align: center;">Payment Already Done</span>
								</div>
								</div>`);
							$("#details").show();
						}else{
							...
							$("#labour_name").val(data.return_product.labour_name);
							$("#quantity").val(data.return_product.returned_quantity);
							$("#labour_rate").val(data.return_product.labour_rate);
							$("#amount_to_pay").val(parseFloat(data.return_product.labour_rate * data.return_product.returned_quantity));
							$("#details").show();
						}
					} else {
						$("#returned_product_error_span").text(data.message);
