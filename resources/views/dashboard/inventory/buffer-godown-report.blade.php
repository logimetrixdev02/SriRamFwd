...
@section('title','Buffer Godown Report')
@section('content')
	...
	<div class="main-content-inner">
		<div class="breadcrumbs ace-save-state" id="breadcrumbs">
			<ul class="breadcrumb">
				...
				<li class="active">{{__('messages.Buffer')}} Godown {{__('messages.Report')}}</li>
			</ul>
		</div>
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					<h3 class="header smaller lighter blue">{{__('messages.Buffer')}} Godown {{__('messages.Report')}} </h3>
							...
							<table id="dynamic-table" class="table table-striped table-bordered table-hover">
								...
								<tbody>
									...
									<tr>
										...
										@foreach($inventory_products as $inventory_product)
										<td>
											@if(is_null(getBufferInventoryProductQuantity($party['type'], $party['id'],$inventory_product->product_id,$product_brand_id)))
											0
											@else
											{{getBufferInventoryProductQuantity($party['type'], $party['id'],$inventory_product->product_id,$product_brand_id)}}
											@php
											$total = $total + getBufferInventoryProductQuantity($party['type'], $party['id'],$inventory_product->product_id,$product_brand_id);
											@endphp
											@endif
										</td>
										@endforeach
