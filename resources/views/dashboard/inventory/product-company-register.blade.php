...
@section('title','Product Company Register')
@section('content')
	...
	<div class="main-content-inner">
		<div class="breadcrumbs ace-save-state" id="breadcrumbs">
			<ul class="breadcrumb">
				...
				<li class="#">Stock</li>
				<li class="active">Product Company Register</li>
			</ul>
		</div>

		<div class="page-content">
			<h3 class="header smaller lighter blue"> Product Company Register</h3>
			<div class="row">
				<div class="col-xs-12">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<div class="table-header">
						Results for "Generated Product Company Register"
