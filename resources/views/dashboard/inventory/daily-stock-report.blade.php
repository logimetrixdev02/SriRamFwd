	...
	<div class="main-content-inner">
		<div class="breadcrumbs ace-save-state" id="breadcrumbs">
			<ul class="breadcrumb">
				...
				<li class="active"> Daily  {{__('messages.Stock')}} {{__('messages.Report')}}</li>
			</ul>
		</div>
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					<h3 class="header smaller lighter blue"> Daily  {{__('messages.Stock')}} {{__('messages.Report')}}</h3>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<a class="btn btn-xs bigger btn-danger" href="{{URL('/user/export-daily-stock-report')}}">
							...
							<table id="dynamic-table" class="table table-striped table-bordered table-hover">
								<thead>
									<tr>
										...
										@php
										$stock = \App\Inventory::where('warehouse_id',$warehouse->id)->sum('quantity');
										@endphp
										@if($stock > 0)
								...
								<tbody>
									...
									<tr>
										...
										<td>
											...
											0
											@else 
											{{getPartyInventoryByProductAndBrand($self_party['id'],$product['id'],$product['product_brand_id'],$self_party['type'])}}
										...
										<td>
											{{getOtherPartyInventoryByProductAndBrand($product['id'],$product['product_brand_id'])}}
											@php
										...
										<td>
											...
											0
											@else 
											{{getPartyInventoryByProductAndBrand($product_company['id'],$product['id'],$product['product_brand_id'],$product_company['type'])}}
										...
										<td> 
											...
											0
											@else 
											{{getInventory($product['product_brand_id'],$warehouse['id'],$product['id'])}}
