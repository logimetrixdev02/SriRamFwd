	...
	<div class="main-content-inner">
		<div class="breadcrumbs ace-save-state" id="breadcrumbs">
			<ul class="breadcrumb">
				...
				<li class="active">{{__('messages.Stock')}} {{__('messages.Report')}} </li>
			</ul>
		</div>
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					<h3 class="header smaller lighter blue">{{__('messages.Stock')}} {{__('messages.Report')}}  </h3>
				...
				<div class="col-xs-12">
					...
					<div class="table-responsive">
						...
						<div class="dataTables_borderWrap">
							<table id="" class="datatable table table-striped table-bordered table-hover">
								<thead>
									<tr>
...
<div class="modal fade" id="addDealerModal">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h4 class="modal-title">  {{__('messages.Dealer')}} {{__('messages.AddNew')}}</h4>
			</div>
			<div class="modal-body">
...
<div class="modal fade" id="editDealerModal">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h4 class="modal-title">  {{__('messages.Dealer')}} {{__('messages.Update')}}</h4>
			</div>
