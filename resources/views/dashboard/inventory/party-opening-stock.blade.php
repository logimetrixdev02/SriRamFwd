...
@section('title','Party Opening Inventory')
@section('content')
	...
	<div class="main-content-inner">
		<div class="breadcrumbs ace-save-state" id="breadcrumbs">
			<ul class="breadcrumb">
				...
				<li class="#">Stock</li>
				<li class="active">Party Opening Inventory</li>
			</ul>
		</div>

		<div class="page-content">
			<h3 class="header smaller lighter blue"> Party Opening Inventory</h3>
			<div class="row">
				<div class="col-xs-12">
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<select class="form-control select2" name="product_brand_id" id="product_brand_id">
										...
										@foreach($product_companies as $product_company)
										<option value="{{$product_company->id}}" {{isset($product_brand_id) && $product_brand_id==$product_company->id ? "selected":""}}>{{$product_company->brand_name}}</option>
										@endforeach()
									</select>
							...
							<table id="dynamic-table" class="table table-striped table-bordered table-hover">
								...
								<tbody>
									...
									<tr>
										...
										<td><b>{{$inventory->product_brand->brand_name}} </b></td>
