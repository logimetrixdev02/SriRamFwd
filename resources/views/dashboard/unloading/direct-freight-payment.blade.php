...
<div class="main-content">
	<div class="main-content-inner">
		...
		<div class="page-content">
			...
			<form action="{{url('/user/pay-direct-unloading-freight')}}" method="post" role="form" id="freightPaymentForm" onsubmit="return validateForm()">
				{{ csrf_field() }}
				<div class="container">
					<div class="row">
		...
		if (qr_value == "") {
			...
			$.ajax({
				...
				success:function(data){
					...
					$(".loading-bg").hide();
					if (data.flag) {
						if(data.product_unloading.loading_slip_type == "0"){
