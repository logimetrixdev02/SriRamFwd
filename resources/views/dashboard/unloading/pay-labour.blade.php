...
<div class="main-content">
	<div class="main-content-inner">
		...
		<div class="page-content">
			...
			<form action="{{url('/user/unloading-labour-payment')}}" method="post" role="form" id="labourPaymentForm">
				{{ csrf_field() }}
				<div class="container">
					<div class="row">
							...
							<div class="panel-body">
								<div class="col-md-4">
									<div class="form-group">
										<label for="qr_data"> Labour Slip</label>
										<input type="text" class="form-control" name="qr_data" id="qr_data" onchange="getUnloadingLabourSlipDetails(this.value)">
									</div>
								</div>
...
<script type="text/javascript">
	...
	function getUnloadingLabourSlipDetails(qr_value){
		var url ="{{url('get-unloading-labour-slip-details')}}";
		if (qr_value == "") {
			swal({
