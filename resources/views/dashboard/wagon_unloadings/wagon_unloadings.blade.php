							...
							<table id="dynamic-table" class="table table-striped table-bordered table-hover">
								...
								<tbody>
									...
									<tr>
										...
										<td>{{$wagon_unloading->amount}}</td>
										<td>{{$wagon_unloading->description}}</td>
										<td>
										...
										<td><a href="{{URL('/user/print-direct-labour-payment-slip/'.$wagon_unloading->id)}}"><i class="fa fa-print fa-2x"></i></a></td>
								...
								$total_to_pay = $total_to_pay + ($wagon_unloading->amount);
								@endphp
