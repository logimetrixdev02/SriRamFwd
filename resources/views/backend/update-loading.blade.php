							...
							<div class="row">
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<input type="text" name="driver_number" id="driver_number" class="form-control" value="{{$current_loading->driver_number}}">
									</div>
								</div>
								<div class="col-md-4">
									<div class="form-group">
										<label for="wagon_number">Wagon Number</label>
										<input type="text" name="wagon_number" id="wagon_number" class="form-control" value="{{$current_loading->wagon_number}}">
									</div>
								</div>
