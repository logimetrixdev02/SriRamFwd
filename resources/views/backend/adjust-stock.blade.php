		...
		<div class="page-content">
			<div class="panel panel-primary">
				<div class="panel-heading">
					<h3 class="panel-title">Adjust Stock</h3>
				</div>
					...
					<form action="" role="form" id="" method="post" onsubmit="return validateForm()">
						...
						<div class="container">
							<div class="row">
								...
								<div class="col-md-4">
									<div class="form-group">
										<label for="adjust_from">Adjust From</label>
										<select class="form-control select2" name="adjust_from" id="adjust_from">
											<option value="">Choose</option>
											<option value="30">Adjustment Company</option>
										</select>
									</div>
								</div>
								...
								<div class="col-md-4">
									<div class="form-group">
										<label for="adjust_type">Adjust Type</label>
										<select class="form-control select2" name="adjust_type" id="adjust_type">
